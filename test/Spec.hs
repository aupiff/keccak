...
keccakEmptyAbsorbtionTest = assertEqual "Absorbs empty input properly" endState (absorb 1088 . toBlocks 136 $ paddingKeccak 136 "")
...
keccakAsciiAbsorbtionTest = assertEqual "Absorbs ascii input properly" asciiState (absorb 1088 . toBlocks 136 $ paddingKeccak 136 "testing")
